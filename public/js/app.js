        ...
        dataJson['items'].forEach(function(data) {
            ...
            <div class="blog-box row">
                ...
                <div class="blog-meta big-meta col-md-8">
                    ...
                    <span class="bg-aqua" onclick="naviToscreen()" id="${data.id}><i class="fa fa-heart"></i></span> 
                    <span class="bg-aqua" onclick="naviToscreen()" id="${data.id}><i class="fas fa-cart-arrow-down"></i></span> 
